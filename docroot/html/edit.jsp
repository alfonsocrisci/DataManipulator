...
<%@ page import="yg0r2.datamanipulator.displayfield.FieldKeys"%>
<%@ page import="yg0r2.datamanipulator.displayfield.DisplayFields"%>
<%@ page import="yg0r2.datamanipulator.handler.BaseHandler"%>
...
<aui:form action="<%= createURL %>" enctype="multipart/form-data" method="post" name="fm">
	...
	DisplayFields displayFields = handler.getDisplayFields(themeDisplay.getScopeGroupId());
	...
	for (String name : names) {
		...
		if (type.equals(FieldKeys.CHECK_BOX)) {
			...
			<aui:model-context bean="<%= null %>" model="<%= yg0r2.datamanipulator.handler.BaseHandler.class %>" />
			<aui:layout>
