...
public class SiteHandler extends BaseHandler {
	...
	protected Class<?>[] getAddArgClazzs() {
		return new Class<?>[] {
			Long.TYPE, String.class, Long.TYPE, Long.TYPE, String.class,
			String.class, Integer.TYPE, String.class, Boolean.TYPE,
	...
	protected String[] getAddArgNames() {
		return new String[] {
			"userId", "className", "classPK", "liveGroupId", "name",
			"description", "type", "friendlyURL", "site", "active",
			"serviceContext"
		};
	}
