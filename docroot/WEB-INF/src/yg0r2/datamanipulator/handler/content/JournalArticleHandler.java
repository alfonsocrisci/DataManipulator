 ...
 * @author Yg0R2
 */
@Handler(type = HandlerType.CONTENT, displayName = "Journal Handler")
public class JournalArticleHandler extends BaseHandler {
	...
	protected String[] getAddArgNames() {
		...
		return new String[] {
			...
			"descriptionMap", "content", "type", "ddmStructureKey",
	...
	private List<KeyValuePair> _getStructureNameKeys(long groupId)
		...
		for (DDMStructure structure : structures) {
			if (structure.getClassNameId() == _journalClassNameId) {
