...
package yg0r2.datamanipulator.displayfield;
...
public class DisplayFields {
	...
	public void add(String name, String type) throws SystemException {
		add(name, type, StringPool.BLANK);
	}
	...
	public void add(String name, String type, Object defaultValue)
		...
		if (type.equals(FieldKeys.CHECK_BOX)) {
			if (Validator.isNull(defaultValue)) {
				...
				addCheckbox(name, Boolean.valueOf((String) defaultValue));
			}
		}
			...
			if (Validator.isNull(defaultValue)) {
				...
				addInput(name, (String) defaultValue);
			}
		}
			...
			if (Validator.isNull(defaultValue)) {
				...
				addInput(name, (String) defaultValue, true);
			}
		}
		else if (type.equals(FieldKeys.INPUT_COUNT)) {
			addCount(name);
		}
		else if (type.equals(FieldKeys.INPUT_REQUIRED_COUNT)) {
			addCount(name, true);
		}
		else if (type.equals(FieldKeys.INPUT_DEPTH)) {
			addDepth(name);
		}
		else if (type.equals(FieldKeys.INPUT_REQUIRED_DEPTH)) {
			addDepth(name, true);
		}
		else if (type.equals(FieldKeys.INPUT_SUBCOUNT)) {
			addSubCount(name);
		}
		else if (type.equals(FieldKeys.INPUT_REQUIRED_SUBCOUNT)) {
			addSubCount(name, true);
		}
		else if (type.equals(FieldKeys.INPUT_UPDATE_COUNT)) {
			addUpdateCount(name);
		}
		else if (type.equals(FieldKeys.INPUT_REQUIRED_UPDATE_COUNT)) {
			addUpdateCount(name, true);
		}
		else if (type.equals(FieldKeys.LABEL)) {
			addLabel(name);
		}
		else if (type.equals(FieldKeys.MULTI_SELECT_LIST)) {
			addMultiSelectList(name, (List<KeyValuePair>) defaultValue);
		}
		else if (type.equals(FieldKeys.MULTI_SELECT_ORGANIZATION_LIST)) {
			addOrganizationMultiSelect(name);
		}
		else if (type.equals(FieldKeys.MULTI_SELECT_ROLE_LIST)) {
			addRoleMultiSelect(name);
		}
		else if (type.equals(FieldKeys.MULTI_SELECT_SITE_LIST)) {
			addSiteMultiSelect(name);
		}
		else if (type.equals(FieldKeys.MULTI_SELECT_USER_LIST)) {
			addUserMultiSelect(name);
		}
		else if (type.equals(FieldKeys.MULTI_SELECT_USERGROUP_LIST)) {
			addUserGroupMultiSelect(name);
		}
		else if (type.equals(FieldKeys.SELECT_ADD_TO_PARENT)) {
			addAddToParentSelect(name);
		}
		else if (type.equals(FieldKeys.SELECT_LIST)) {
			addSelectList(name, (List<KeyValuePair>) defaultValue);
		}
